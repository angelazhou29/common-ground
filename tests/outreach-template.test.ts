...
const contact:Contact={id:'person',name:'Fixture Person',title:'Equity Sales Analyst',company:'Wells Fargo',industry:'Sales & Trading',location:'Chicago',email:'fixture@example.com',linkedin:'',timezone:'America/Chicago',status:'Ready for review',verification:'unknown',verifiedAt:'',emailOrigin:'published',identityConfirmed:true,fit:'Published role',topic:'Equity sales',notes:'',sources:[{url:'https://example.com/team',note:'Equity sales desk',retrievedAt:'2026-09-23'}],desk:'sales',productGroup:'equities',deskEvidence:'The official team page identifies the equity sales desk.'};
